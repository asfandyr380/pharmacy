...
class NewPurchaseViewModel extends ChangeNotifier {
  ...
  savePurchase() async {
    if (connection) {
      if (productlist.isNotEmpty) {
        ...
        await _purchaseService.createNewPurchase(model).then((value) async {
          await _purchaseService
              .createPurchasedMedicine(productlist, value)
              .then((value) async {
            await _stockService.addMultipleStock(
              productlist,
