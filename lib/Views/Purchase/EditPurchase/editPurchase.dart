...
import 'package:medical_store/Views/Purchase/EditPurchase/editPurchaseViewModel.dart';
...
class EditPurchaseView extends StatefulWidget {
  ...
  const EditPurchaseView({required this.model});
...
class _EditPurchaseViewState extends State<EditPurchaseView> {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<EditPurchaseViewModel>.reactive(
      viewModelBuilder: () => EditPurchaseViewModel(),
              ...
              ListingBox(
                boxContent: ListingBoxContent(
                  contentWidget: NewMedicineContent(
                    ...
                    mode: model.mode,
                    onSave: () => model.savetolist(widget.model),
                    ...
                    savePurchase: () => model.savePurchase(widget.model),
